...
export const ModalContent = ({ hideGotoPost, postId, closeModal }) => {
  ...
  return (
    <ModalContentWrapper>
      ...
      <ModifyPost postId={postId} closeModal={closeModal} goToHome={true} />
  ...
  return (
    <PostWrapper>
      <div className="post-header-wrapper">
        ...
        {showModal && (
          <Modal>
            <ModalContent postId={post.id} closeModal={closeModal} />
          </Modal>
        )}
      ...
      <div className="post-actions">
        <LikePost
          ...
          decLikes={decLikes}
        />
        <CommentIcon onClick={() => history.push(`/p/${post.id}`)} />
        <InboxIcon />
